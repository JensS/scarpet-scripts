...
global_proximity_messages = [
    ...
    ['Uh oh! ', ' and ', ' are within range! Take cover!'],
    ['Radar ping: ', ' detected near ', '! Evasive maneuvers recommended!'],
    ['Plot twist: ', ' and ', ' are now neighbors!'],
    ['Attention: ', ' has entered ', '\'s personal bubble!'],
    ['Warning! ', ' and ', ' are about to have an encounter!'],
    ['Player convergence detected: ', ' × ', ' = ???'],
    ['The universe has brought ', ' and ', ' together. How romantic!'],
    ['Awkward meter rising: ', ' and ', ' in close proximity!'],
    ['BOOP! ', ' and ', ' are close enough to boop!'],
    ['Caution: ', ' and ', ' might make eye contact!'],
    ['Oh no! ', ' stumbled into ', '\'s area!'],
    ['Proximity sensors going wild! ', ' near ', '!'],
    ['Human interaction alert: ', ' + ', ' = potential conversation!'],
    ['Look out! ', ' and ', ' sharing the same airspace!'],
    ['Collision course: ', ' heading straight for ', '!'],
    ['Same coordinates detected: ', ' and ', '!'],
    ['Space invaders: ', ' has invaded ', '\'s space!'],
    ['Friend or foe? ', ' spotted near ', '!'],
    ['Danger zone! ', ' and ', ' in the same area!'],
    ['Now playing: ', ' ft. ', ' - "Too Close"'],
    ['Matchmaker alert: ', ' + ', ' = Match made in Minecraft!'],
    ['Party forming! ', ' and ', ' detected!'],
    ['Co-op mode activated: ', ' and ', '!'],
    ['Dynamic duo spotted: ', ' and ', '!'],
    ['Oh snap! ', ' ran into ', '!'],
    ['Buddy system engaged: ', ' × ', '!'],
    ['Same chunk alert: ', ' and ', '!'],
    ['Personal space? Never heard of it. - ', ' and ', ''],
    ['The stars aligned and brought ', ' to ', '!'],
    ['Proximity trigger: ', ' ↔ ', '!']
];
